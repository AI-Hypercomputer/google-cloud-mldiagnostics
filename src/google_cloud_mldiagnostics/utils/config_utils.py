...
def _get_framework_version(framework: mlrun_types.Framework) -> str:
...
def get_hardware_config(
  ...
  config_instance = _get_framework_config_instance(framework)
  if config_instance:
...
def get_accelerator_type(
  ...
  detected = host_utils.get_accelerator_type(framework)
